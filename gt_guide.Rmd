...
<!-- Follow our coding standards, example is code chunk names. Don't have to have comments in code chunks which we show students since you explain them in the text. -->

<!-- Give me some key links at the top. -->

<!-- Can you make the CI footnote disappear?  -->

<!-- Show example of adding our own footnote to the regression table. For the p-value, "Calculated via a permutation test." -->

<!-- Use maps.Rmd for guidance in footnoting and stuff.  -->

<!-- Feel free to add some videos or memes. -->

<!-- Find a place to show math notation. Save md() for having a column named $Y_i$. Or maybe for header span. See Chapter 3. -->
...
<!-- Explain the vars thing. Explain that a line return does not effect things in the md().  -->
